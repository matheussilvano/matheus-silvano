document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    pt: {
      ...
      impact_cnpj: "+170 usuários na Web Store, reduzindo o tempo de copiar CNPJ formatado em ~20s por uso.",
      ...
      project4_impact: "170+ usuários ativos na Web Store, economizando ~20s por cópia.",
    ...
    en: {
      ...
      impact_cnpj: "170+ Web Store users, cutting the time to copy formatted CNPJ by ~20s per use.",
      ...
      project4_impact: "170+ active Web Store users, saving ~20s per copy.",
    ...
    es: {
      ...
      impact_cnpj: "170+ usuarios en la Web Store, reduciendo el tiempo de copiar CNPJ formateado en ~20s por uso.",
      ...
      project4_impact: "170+ usuarios activos en la Web Store, ahorrando ~20s por copia.",
