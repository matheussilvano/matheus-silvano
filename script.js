document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    pt: {
      ...
      exp0_title: "Dígitro - Desenvolvedor de IA Jr.",
      exp0_date: "Fev 2026 - Atual",
      exp0_b1: "Implementação de soluções RAG com fontes internas, elevando precisão e rastreabilidade das respostas.",
      exp0_b2: "Integração de ferramentas via MCP para orquestração de agentes e acesso seguro a sistemas internos.",
      exp0_b3: "Criação de pipelines de avaliação e observabilidade para LLMs em produção.",
      exp1_title: "Dígitro - Estagiário em Desenvolvimento de IA",
      exp1_date: "Abr 2025 - Fev 2026",
      exp1_b1: "Avaliação e comparação de LLMs para diagnósticos de chamadas VoIP, reduzindo tempo de análise.",
      exp1_b2: "Prototipagem de fluxos RAG e testes de recuperação para base de conhecimento interna.",
    ...
    en: {
      ...
      exp0_title: "Dígitro - Junior AI Developer",
      exp0_date: "Feb 2026 - Present",
      exp0_b1: "Implemented RAG solutions with internal sources, improving answer accuracy and traceability.",
      exp0_b2: "Integrated tools via MCP to orchestrate agents and provide secure access to internal systems.",
      exp0_b3: "Built evaluation and observability pipelines for LLMs in production.",
      exp1_title: "Dígitro - AI Development Intern",
      exp1_date: "Apr 2025 - Feb 2026",
      exp1_b1: "Evaluated and compared LLMs for VoIP call diagnostics, cutting analysis time.",
      exp1_b2: "Prototyped RAG workflows and retrieval tests for an internal knowledge base.",
    ...
    es: {
      ...
      exp0_title: "Dígitro - Desarrollador de IA Jr.",
      exp0_date: "Feb 2026 - Actual",
      exp0_b1: "Implementación de soluciones RAG con fuentes internas, mejorando precisión y trazabilidad de respuestas.",
      exp0_b2: "Integración de herramientas vía MCP para orquestación de agentes y acceso seguro a sistemas internos.",
      exp0_b3: "Creación de pipelines de evaluación y observabilidad para LLMs en producción.",
      exp1_title: "Dígitro - Pasante en Desarrollo de IA",
      exp1_date: "Abr 2025 - Feb 2026",
      exp1_b1: "Evaluación y comparación de LLMs para diagnósticos de llamadas VoIP, reduciendo tiempo de análisis.",
      exp1_b2: "Prototipado de flujos RAG y pruebas de recuperación para base de conocimiento interna.",
